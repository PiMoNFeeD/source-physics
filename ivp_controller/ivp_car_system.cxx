...
{
	car_act_powerslide_back->set_force( car_body->get_core()->get_mass() * front_accel );
	car_act_powerslide_front->set_force( car_body->get_core()->get_mass() * rear_accel );
}
...
{
	// PiMoN: this is really fucked up!
	car_body->get_core()->get_m_world_f_core_PSI()->vmult4( &car_act_powerslide_back->get_actuator_anchor( 0 )->core_pos, &carSystemDebugData.backActuatorLeft );
	car_body->get_core()->get_m_world_f_core_PSI()->vmult4( &car_act_powerslide_back->get_actuator_anchor( 1 )->core_pos, &carSystemDebugData.backActuatorRight );
	car_body->get_core()->get_m_world_f_core_PSI()->vmult4( &car_act_powerslide_front->get_actuator_anchor( 0 )->core_pos, &carSystemDebugData.frontActuatorLeft );
	car_body->get_core()->get_m_world_f_core_PSI()->vmult4( &car_act_powerslide_front->get_actuator_anchor( 1 )->core_pos, &carSystemDebugData.frontActuatorRight );
}
